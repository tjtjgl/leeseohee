...
var positions = [
    {
        content: '<div>남산케이블카</div>',
        latlng: new kakao.maps.LatLng(37.55657351159653, 126.98402420829015)
    },
    {
        content: '<div>서울 빛초롱 축제</div>',
        latlng: new kakao.maps.LatLng(37.568902522514165, 126.9824368634189)
    },
    {
        content: '<div>서울 김장 문화제</div>',
        latlng: new kakao.maps.LatLng(37.56556455096061, 126.97832663494748)
    },
    {
        content: '<div>하이 서울 마라톤</div>',
        latlng: new kakao.maps.LatLng(37.56505272995852, 126.97802796720994)
    },
    {
        content: '<div>서울 동행 축제</div>',
        latlng: new kakao.maps.LatLng(37.55808105651951, 127.00090541873718)
    },
    {
        content: '<div>2023 청소년 페스티벌</div>',
        latlng: new kakao.maps.LatLng(37.58923988887918, 127.01667117621346)
    },
    {
        content: '<div>동대문구 체육대회</div>',
        latlng: new kakao.maps.LatLng(37.57449780397403, 127.03950756086842)
    },
    {
        content: '<div>드론 페스티벌</div>',
        latlng: new kakao.maps.LatLng(37.57336366191718, 126.97884509708854)
    },
    {
        content: '<div>뚜벅 뚜벅 축제</div>',
        latlng: new kakao.maps.LatLng(37.57912939184351, 126.93674776233395)
    },
    {
        content: '<div>서울 드럼 페스티벌</div>',
        latlng: new kakao.maps.LatLng(37.56618168282231, 126.90186915964489)
    },
    {
        content: '<div>2023 서울 장미 축제</div>',
        latlng: new kakao.maps.LatLng(37.532391394364986, 126.99057329923504)
    },
    {
        content: '<div>벚꽃 축제</div>',
        latlng: new kakao.maps.LatLng(37.56340559417191, 127.036889383777)
    }
];

// 마커 이미지의 이미지 주소입니다
var imageSrc = "./img/stamp.png";
...
function displayArea(area) {
    ...
    // 클로저를 사용하여 이벤트 리스너를 등록
    kakao.maps.event.addListener(polygon, 'click', (function (polygon, name) {
        return function () {
            // 클릭한 폴리곤의 영역을 지도에 맞게 확대
            var bounds = new kakao.maps.LatLngBounds();
            for (var j = 0; j < polygon.getPath().length; j++) {
                bounds.extend(polygon.getPath()[j]);
            }

            map.setBounds(bounds);

            // 더 큰 확대 레벨로 지도 설정 (예: level: 13)
            map.setLevel(5);
